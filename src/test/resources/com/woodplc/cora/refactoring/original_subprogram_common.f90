...
subroutine delete_sb_moment_loads(idsbn,node1,node2,disp1)
 use hddim, only : nonp, n1
 implicit none
  ! ----------------------------------------------------------------------
  ...
  ! common block vars
  common/rigidbed/rlmulg,rlmutv,chmax,irigsf,nmsbe,nmsbn, iarbsb,nsbdpt
  common/elastbed/sbstf,stflat,ielasf,ilatstf,sslope


  ! delcared common block types
  real(8) :: rlmulg,rlmutv,chmax
  integer :: irigsf,nmsbe,nmsbn, iarbsb,nsbdpt
  real(8) :: sbstf,stflat, sslope
  integer :: ielasf,ilatstf
